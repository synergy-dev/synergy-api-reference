...
<title>Read [customer version4.0]</title>
</head>
<body>
...
<h1>Read [customer version4.0]</h1>
    ...
    <p><fieldset>
        ...
        <p><fieldset>
            ...
            <input type="radio" name="cond2_dataType" value="select" <?php if (Utils::getParam('cond2_dataType') == 'select') { echo 'checked'; } ?>>selectData<br/>
                ...
                &nbsp&nbsp value : <input type="text" name="cond2_value_2" size="5" value=<?php echo htmlspecialchars(Utils::getParam('cond2_value_2')); ?>>
        </fieldset></p>
    </fieldset></p>
    
    <p><fieldset>
    limit : <input type="text" name="limit" size="5" value=<?php echo htmlspecialchars(Utils::getParam('limit')); ?>><br/>
    offset : <input type="text" name="offset" size="5" value=<?php echo htmlspecialchars(Utils::getParam('offset')); ?>><br/>
    sortcolumn : <input type="text" name="sortcolumn" size="20" value=<?php echo htmlspecialchars(Utils::getParam('sortcolumn')); ?>><br/>
    isDesc : <input type="text" name="isDesc" size="5" value=<?php echo htmlspecialchars(Utils::getParam('isDesc')); ?>>
    </fieldset></p>
...
<?php
    if (count($_GET) > 0) {
        ...
        // レスポンスデータ表示
        HTMLWriter::writeReadResponse($response);
    }
?>
</body>
</html>
